      ...
      <block v-for="(item, index) in storeList" :key="index">
        <view class="store_lister">
          ...
          <view class="store_lister_top">
            <text :data-id="item.id" @tap="go_storeindex" class="one">{{
              item.storename
            }}</text>
            <view class="two">
              <text></text>
            ...
            <view @tap="collphone" :data-tel="item.tel" class="three">
              <image
                mode="widthFix"
                src="http://wximage.shedongyun.com/sdo2o/phone_list.png"
              ></image>
            </view>
          </view>
          <view class="store_lister_text">
            <image
              ...
              @tap="go_storeindex"
              mode="widthFix"
              src="http://wximage.shedongyun.com/sdo2o/list_date.png"
            ></image>
            <text :data-id="item.id" @tap="go_storeindex">{{
              item.saletime
            }}</text>
          </view>
          <view
            ...
            @tap="getmap"
            class="store_lister_text"
          >
            <image
              mode="widthFix"
              src="http://wximage.shedongyun.com/sdo2o/list_add.png"
            ></image>
            <text class="text">{{ item.address }}</text
            ><text class="distance">丨</text
