    ...
    <block v-for="(item, index) in reasonList" :key="index">
      <view class="cancel_line">
        ...
        <view class="cancel_select">
          <image src="http://wximage.shedongyun.com/sdo2o/false.png" :class="'select_logo ' + (item.checked==true?'hide':'show')"></image>
          <image src="http://wximage.shedongyun.com/sdo2o/true.png" :class="'select_logo ' + (item.checked==true?'show':'hide')"></image>
