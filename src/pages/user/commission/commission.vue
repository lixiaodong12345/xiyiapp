...
<view class="withdrawals_money">
  ...
  <text class="wm_tx02" style="color:#FE5455;">{{commission.wait}}元</text>
</view>
<view class="border006"></view>
<view class="withdrawals_money">
...
<view class="border006"></view>
<view class="txt_all">
    <text class="txt_002">买家确认收货后，立即获得佣金,3天后佣金可提现！</text>
    <view class="txt_003"><image mode="widthFix" src="http://wximage.shedongyun.com/sdo2o/pomit.png"></image>可用佣金满{{commission.withdraw}}元后才能申请提现</view>
</view> 
<view class="border006"></view>
<button class="btn_1" :data-money="commission.wait" @tap="getMoney">申请提现</button>
</view>
</template>
