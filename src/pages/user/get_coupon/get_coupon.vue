      ...
      <view class="line_cont">
          <view class="line_cont_left">
            <view class="conpon_type">
              ...
              <text class="type" v-else-if="coupon.backtype==1">折扣券</text>
              <text class="type_employ">({{coupon.coupon_range}})</text>
            </view>
            <view class="cont_left_title">
              <text class="cont_price" v-if="coupon.backtype==0"><text class="cont_symble">￥</text>{{coupon.deduct}}</text>
              <text class="cont_price" v-else-if="coupon.backtype==1">{{coupon.discount}}<text class="cont_symble">折</text></text>
              <text class="cont_use">满{{coupon.enough}}元使用</text>
            </view>
            <text class="cont_time">{{coupon.timestart}}~{{coupon.timeend}}</text>
          </view>
          ...
          <view class="line_cont_right">
            <view class="content"> 
                ...
                <image v-if="coupon.bfb==0" class="coupon_img" mode="widthFix" src="http://wximage.shedongyun.com/sdo2o/coupon_00.png"></image>
                <image v-if="coupon.bfb>0&&coupon.bfb<=13" class="coupon_img" mode="widthFix" src="http://wximage.shedongyun.com/sdo2o/coupon_01.png"></image>
                <image v-if="coupon.bfb>13&&coupon.bfb<=25" class="coupon_img" mode="widthFix" src="http://wximage.shedongyun.com/sdo2o/coupon_02.png"></image>
                <image v-if="coupon.bfb>25&&coupon.bfb<=50" class="coupon_img" mode="widthFix" src="http://wximage.shedongyun.com/sdo2o/coupon_03.png"></image>
                <image v-if="coupon.bfb>50&&coupon.bfb<=62" class="coupon_img" mode="widthFix" src="http://wximage.shedongyun.com/sdo2o/coupon_04.png"></image>
                <image v-if="coupon.bfb>62&&coupon.bfb<=75" class="coupon_img" mode="widthFix" src="http://wximage.shedongyun.com/sdo2o/coupon_05.png"></image>
                <image v-if="coupon.bfb>75&&coupon.bfb<=87" class="coupon_img" mode="widthFix" src="http://wximage.shedongyun.com/sdo2o/coupon_06.png"></image>
                <image v-if="coupon.bfb>87" class="coupon_img" mode="widthFix" src="http://wximage.shedongyun.com/sdo2o/coupon_07.png"></image>
            </view> 
            <view class="coupon_button">
              <text :data-id="coupon.id" @tap="receiveCoupon">立即领取</text>
            </view>
          </view> 
          </form>
      </view><!--line_cont-->
    ...
    <view class="coupon_line coupon_line_none">
      ...
      <view class="line_cont">
          <view class="line_cont_left">
            ...
            <view class="cont_left_title">
              <text class="cont_price"><text class="cont_symble">￥</text>{{coupon.deduct}}</text>
              <text class="cont_use">满{{coupon.enough}}元使用</text>
            </view>
            <text class="cont_time">{{coupon.timestart}}~{{coupon.timeend}}</text>
          </view>
      ...
      wx.request({
        ...
        success: function (res) {
          ...
          for (var m = 0; m < res.data.data.length; m++) {
            var bfb = Math.ceil(res.data.data[m].receive / res.data.data[m].total * 100);
