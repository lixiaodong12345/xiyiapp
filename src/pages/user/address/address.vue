  ...
  <view class="add_body">
    <navigator redirect="true" url="/pages/shop/flow/flow?id=1">
      <view class="flow_tis" :style="flow_tis_style">
        <text class="flow_tis_text"
          >请选择一个收货地址设为默认,点我继续结算喔！</text
        >
      </view>
    </navigator>
    ...
    <block v-if="user_address != ''">
          ...
          <view class="edit_menu">
            ...
            <view class="dele_edit">
              ...
              <image
                ...
                @tap="del_address"
                mode="widthFix"
                src="http://wximage.shedongyun.com/sdo2o/add_dele.png"
              ></image>
              <navigator
                :url="
                  '/pages/user/edit_address/edit_address?commod_id=' + item.id
                "
              >
                ...
                <image
                  class="ico"
                  mode="widthFix"
                  src="http://wximage.shedongyun.com/sdo2o/add_write.png"
                ></image>
              </navigator>
            </view>
          </view>
      ...
      <view class="footer2">
        <navigator
          url="/pages/user/edit_address/edit_address"
          hover-class="none"
          open-type="redirect"
        >
          <image
            mode="widthFix"
            src="http://wximage.shedongyun.com/sdo2o/add_add.png"
            class="footer2_img"
          ></image>
          <text>添加新地址</text>
        </navigator>
