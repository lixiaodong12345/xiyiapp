...
<view class="success_wrap">
 <image mode="widthFix" src="http://wximage.shedongyun.com/sdo2o/depost_success.png" class="depost_success"></image>
 <view class="success_name">充值成功</view>
 <view class="success_money">本次充值金额{{moneyValue}}元</view>
 <view class="success_send" v-if="stateValue==1">赠送<text>{{giveValue}}</text>积分</view>
 <view class="success_send" v-else-if="stateValue==2">赠送<text>{{giveValue}}</text>元</view>
