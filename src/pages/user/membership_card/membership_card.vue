...
<view class="container_wrap">
  ...
  <view class="card_detail">
    <view class="card_main">
      <image src="/static/static/images/card_back.png" class="card_image"></image>
      <view class="card_content">
        <view class="card_inform">
          ...
          <view class="top_up" @tap="top_skip">
            ...
            <image src="/static/static/images/deposit_right.png" class="top_deposit"></image>
          </view>
        </view>
      </view>
    </view>
  ...
  <view class="card_nav">
   <view class="nav_width">
     <view class="nav_line">
       <text @tap="nav_switch" data-nav="0" :class="currId==0?'nav_select':''">积分明细</text>
     </view>
     <view class="line_color"></view>
     <view class="nav_line">
       <text @tap="nav_switch" data-nav="1" :class="currId==1?'nav_select':''">余额明细</text>
     </view>
   </view>
  </view>
  <!--积分明细-->
        ...
        <view class="particul_year">
          <view class="particul_main">
            ...
            <view class="particul_line">
              <image src="/static/static/images/card_out.png" class="particul_logo"></image>
              <view class="particul_inform">
                ...
                <view class="inform_money">-500<text class="inform_name">积分</text></view>
              </view>
            </view><!--particul_line-->
            <view class="particul_line">
              <image src="/static/static/images/card_enter.png" class="particul_logo"></image>
              <view class="particul_inform">
                <view class="inform_title">充值</view>
                <text class="inform_use">[充值]</text>
                <view class="inform_time">09-02 12：45</view>
                <view class="inform_money red_color">+500<text class="inform_name">积分</text></view>
              </view>
            </view><!--particul_line-->
          </view>
        </view><!--particul_year-->
